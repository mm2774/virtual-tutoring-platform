    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('INITIALIZED', 'INITIALIZED'), ('REQUESTED', 'REQUESTED'), ('CONFIRMED', 'CONFIRMED'), ('COMPLETED', 'COMPLETED')], default='INITIALIZED', max_length=20)),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='meetings.course')),
